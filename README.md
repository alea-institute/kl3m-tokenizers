...
* [x] **kl3m-004-128k**: [README](kl3m-004-128k-uncased/README.md)  |  [Hugging Face](https://huggingface.co/alea-institute/kl3m-004-128k-uncased) | Updated KL3M tokenizer (November 2024)
* [ ] **kl3m-004-128k-cased**: In progress
...
```
+=============+================+================+=========================+
| gpt-4o      | kl3m-001-32k   | kl3m-003-64k   | kl3m-004-128k-uncased   |
+=============+================+================+=========================+
| The         | The            | The            | the                     |
+-------------+----------------+----------------+-------------------------+
|  Compt      |                | ĠComptroller   | Ġcomptroller            |
+-------------+----------------+----------------+-------------------------+
| roller      | Comp           | Ġof            | Ġof                     |
+-------------+----------------+----------------+-------------------------+
|  of         | troller        | Ġthe           | Ġthe                    |
+-------------+----------------+----------------+-------------------------+
|  the        |                | ĠCurrency      | Ġcurrency               |
+-------------+----------------+----------------+-------------------------+
|  Currency   | of             | Ġshall         | Ġshall                  |
+-------------+----------------+----------------+-------------------------+
|  shall      |                |                |                         |
+-------------+----------------+----------------+-------------------------+
|             | the            |                |                         |
...
| This          | This           | This           | this                    |
+---------------+----------------+----------------+-------------------------+
|  Securities   |                | ĠSecurities    | Ġsecurities             |
+---------------+----------------+----------------+-------------------------+
|  Purchase     | Securities     | ĠPurchase      | Ġpurchase               |
+---------------+----------------+----------------+-------------------------+
|  Agreement    |                | ĠAgreement     | Ġagreement              |
+---------------+----------------+----------------+-------------------------+
|  (            | Purchase       | Ġ(             | Ġ(                      |
+---------------+----------------+----------------+-------------------------+
| this          |                | this           | this                    |
...
|  as           | "              | Ġas            | Ġas                     |
+---------------+----------------+----------------+-------------------------+
|  of           | Agreement      | Ġof            | Ġof                     |
+---------------+----------------+----------------+-------------------------+
|  November     | ")             | ĠNovember      | Ġnovember               |
+---------------+----------------+----------------+-------------------------+
|               |                | Ġ21            | Ġ21                     |
+---------------+----------------+----------------+-------------------------+
| 21            | is             | ,              | ,                       |
